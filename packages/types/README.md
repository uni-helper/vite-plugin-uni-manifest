...
<p style="text-align: center">
  ...
  <a href="https://npmx.dev/package/@uni-helper/uni-manifest-types"><img src="https://img.shields.io/npm/dm/@uni-helper/uni-manifest-types?colorA=005947&colorB=eee&style=for-the-badge" alt="Downloads"></a>
  <a href="https://npmx.dev/package/@uni-helper/uni-manifest-types"><img src="https://img.shields.io/npm/v/@uni-helper/uni-manifest-types?colorA=005947&colorB=eee&style=for-the-badge" alt="NPM Version"></a>
</p>
<p style="text-align: center">
...
为 `uni-app` 的 `manifest.json` 提供 TypeScript 类型。
...
```bash
pnpm add @uni-helper/uni-manifest-types
```

## 代码内使用

```js
import { AndroidPermissionName, HarmonySigningConfig } from '@uni-helper/uni-manifest-types'
```

完整类型请参考 [./src/index.ts](./src/index.ts)。
