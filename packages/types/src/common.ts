...
export type AndroidPermissionName
  = `android.permission.${AndroidPermissionSuffix}`
    | AndroidPermissionOther

// https://developer.android.com/guide/topics/manifest/uses-feature-element
type AndroidHardwareFeatureSuffix
  = 'audio.low_latency'
    | 'audio.output'
    | 'audio.pro'
    | 'microphone'
    ...
    | 'camera.autofocus'
    | 'camera.flash'
    | 'camera.capability.manual_post_processing'
    | 'camera.capability.manual_sensor'
    | 'camera.capability.raw'
    | 'camera.level.full'
    | 'type.automotive'
    | 'type.television'
    | 'type.watch'
    ...
    | 'telephony.gsm'
    | 'faketouch'
    | 'faketouch.multitouch.distinct'
    | 'faketouch.multitouch.jazzhand'
    | 'touchscreen'
    | 'touchscreen.multitouch'
    | 'touchscreen.multitouch.distinct'
...
type AndroidSoftwareFeatureSuffix
  = 'sip'
    | 'webview'
    | 'input_methods'
    | 'backup'
...
export type AndroidFeatureName
  = `android.hardware.${AndroidHardwareFeatureSuffix}`
    | `android.software.${AndroidSoftwareFeatureSuffix}`
