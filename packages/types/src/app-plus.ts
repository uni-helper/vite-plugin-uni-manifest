import type { AndroidPermissionOrFeature, HEXColor, MaybeArray, PercentageSize, PNG, PxSize } from './common'
 ...
 */
export type AppPlusScreenOrientation = 'portrait-primary' | 'portrait-secondary' | 'landscape-primary' | 'landscape-secondary'
 ...
 * App 平台权限申请策略配置
 */
export interface AppPlusPermissionPrompt {
  /**
   * 权限申请策略
   *
   * "none" 启动时不申请
...
export interface AppPlus {
  ...
  /** 重力感应、横竖屏配置 */
  screenOrientation?: AppPlusScreenOrientation[]
  ...
  distribute?: {
    ...
    android?: {
      ...
      permissionExternalStorage?: AppPlusPermissionPrompt

      /**
       * Android 平台 APP 启动时申请读取设备信息权限配置，详见 <https://ask.dcloud.net.cn/article/36549>
       */
      permissionPhoneState?: AppPlusPermissionPrompt
     ...
     */
    orientation?: AppPlusScreenOrientation[]
